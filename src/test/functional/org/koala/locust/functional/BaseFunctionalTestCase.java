package org.koala.locust.functional;
...
public class BaseFunctionalTestCase {
	...
	public static void beforeClass() throws Exception {
		...
		baseUrl = propertiesLoader.getProperty("baseUrl", LocustStartServer.BASE_URL);
	...
	protected static void startJettyOnce() throws Exception {
		if (jettyServer == null) {
			...
			jettyServer = JettyFactory.createServerInSource(new URL(baseUrl).getPort(), LocustStartServer.CONTEXT);
			JettyFactory.setTldJarNames(jettyServer, LocustStartServer.TLD_JAR_NAMES);
			jettyServer.start();
